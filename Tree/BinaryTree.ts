...
const bt1 = BinaryTree.generate<string>(["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"]);
...
const bt2 = BinaryTree.generate<string>(["1", null, "2", null, "3"]);
...
const bt3 = BinaryTree.generate<number>(case1);
console.log(case1.filter(i => i !== null).toString() === bt3?.bfs()?.toString());
